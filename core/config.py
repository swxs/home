...
MAIL_SERVER_PORT = env.int("MAIL_SERVER_PORT", 587)
...
MAIL_SENDER_NAME = env.str("MAIL_SENDER_NAME", "Home")
MAIL_USE_TLS = env.bool("MAIL_USE_TLS", True)

EMAIL_VERIFY_TOKEN_TTL = env.int("EMAIL_VERIFY_TOKEN_TTL", 2 * 60 * 60)
EMAIL_RESET_TOKEN_TTL = env.int("EMAIL_RESET_TOKEN_TTL", 30 * 60)
EMAIL_RATE_LIMIT_COOLDOWN = env.int("EMAIL_RATE_LIMIT_COOLDOWN", 5 * 60)
EMAIL_RATE_LIMIT_HOURLY_MAX = env.int("EMAIL_RATE_LIMIT_HOURLY_MAX", 3)
...
# 工作流 / LangGraph 相关配置（可从 .env 读取，默认 DeepSeek）
WORKFLOW_OPENAI_API_KEY = env.str("WORKFLOW_OPENAI_API_KEY", "")
WORKFLOW_OPENAI_BASE_URL = env.str("WORKFLOW_OPENAI_BASE_URL", "https://api.deepseek.com/v1")
WORKFLOW_DEFAULT_MODEL = env.str("WORKFLOW_DEFAULT_MODEL", "deepseek-chat")
WORKFLOW_RUN_TIMEOUT_SECONDS = env.int("WORKFLOW_RUN_TIMEOUT_SECONDS", 60)
